  ...
  return (
    <div>
      <section className="flex flex-col lg:flex-row justify-start items-start">
        <div className="bg-primary-100 hidden lg:flex w-full lg:w-[50%] h-screen flex justify-center items-center">
          <Image
        ...
        <div className="bg-stone-300 w-full lg:w-[50%] min-h-screen lg:h-screen flex flex-col justify-center items-center">
          <div className="p-4 w-full py-10 flex flex-col justify-center items-center gap-4 lg:gap-6">
            <div className="px-2 lg:px-16 flex flex-col gap-4">
              <h1 className="text-2xl lg:text-4xl font-semibold text-center text-primary-100">
                VEM SER MADRE!
              </h1>

              <h3 className="text-center text-md lg:text-2xl text-stone-500">
