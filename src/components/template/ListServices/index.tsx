...
export default async function ListServices({ searchParams }: SearchParams) {
  const response = await listServices(searchParams?.page ?? '', {
    name: searchParams?.q ?? '',
  })
      ...
      <div className="p-[5vw] lg:p-[2.5vw] w-full h-full flex flex-col justify-start items-center gap-4">
        ...
        <div className="w-full mt-6 lg:mt-8">
          <Listing
            ...
            hrefButton="dashboard/services/register"
