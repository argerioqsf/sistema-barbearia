...
export const siteConfig: SiteConfig = [
  ...
  },
  {
    id: '8',
    label: 'Meu Painel',
    href: '/dashboard/collaborator-monitoring',
    icon: 'CircleDollarSign',
    userAction: 'collaborator.monitoring.view',
  },
  {
    id: '2',
    label: 'Categorias',
    ...
    subMenuList: [
      {
        ...
        icon: 'Circle',
        userAction: 'financial.payCommission',
      },
      {
        id: '2',
