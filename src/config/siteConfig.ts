  ...
  },
  {
    ...
    subMenuList: [
      ...
      },
      {
        ...
        href: '/dashboard/indicators/pendingPayment',
        icon: 'Circle',
        userAction: 'indicator.pendingPayment.list',
      },
      {
        id: '6',
        label: 'Meus leads',
  ...
  },
  {
    ...
    subMenuList: [
      ...
      },
      {
        id: '3',
        label: 'Pagamentos pendentes',
        href: '/dashboard/consultants/pendingPayment',
        icon: 'Circle',
        userAction: 'consultant.pendingPayment.list',
      },
      {
        id: '6',
        label: 'Meus leads',
